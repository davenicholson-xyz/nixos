        ...
        Rectangle {
            ...
            Row {
                ...
                Repeater {
                    model: 4
                    delegate: Item {
                        property var ws: root.niriWorkspaces.find(w => w.idx === index + 1)
                        property bool isActive: root.niriFocusedIdx === (index + 1)
                        ...
                        MouseArea {
                            anchors.fill: parent
                            onClicked: {
                                niriSwitchWs.command = ["niri", "msg", "action", "focus-workspace", String(index + 1)]
